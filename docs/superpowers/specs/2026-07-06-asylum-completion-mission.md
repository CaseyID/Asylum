...
- Phase B: in progress. Plan: plans/2026-07-06-phase-b-autonomy-loop.md. W1 (event ingestion + catalog truth + interrupt/exit fix) COMPLETE, merged to main f7186bb. Remaining: W0 (2 send_input/launch-submit bugs), W2 (CLI bridge), W3 (launch injection), W4 (hook actions + decision loop), W5 (cockpit). Delivered ingestion contract is documented in the plan for W2/W3.
- Phase C: not started
- Phase D: not started
